...
$this->set('context_menu', array('menus' => array(
	array(
		...
		'items' => array(
			...
			$this->Html->link('<span>People</span>', array('plugin' => 'projects', 'controller' => 'projects', 'action' => 'people', $project['Project']['id']), array('title' => 'People', 'escape' => false, 'class' => 'ui-btn-active')),
			)
		),
	))); ?>
